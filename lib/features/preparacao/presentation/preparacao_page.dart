...
class MedidasController extends StateNotifier<AsyncValue<List<MedidaItem>>> {
  ...
  void setMedicao(int index, String medicao) {
    ...
    final valor =
        double.tryParse(medicao.replaceAll(',', '.').trim());
...
class _MeasurementTile extends StatelessWidget {
  ...
  final void Function(StatusMedida)? onStatusChanged;
  ...
  Widget build(BuildContext context) {
    ...
    final isManual = item.minimo == null && item.maximo == null;
            ...
            if (!isManual)
              ...
              Row(
                children: [
                  Expanded(
                    child: FilledButton(
                      onPressed: () => onStatusChanged?.call(StatusMedida.ok),
                      style: ButtonStyle(
                  ...
                  Expanded(
                    child: FilledButton(
                      onPressed: () =>
                          onStatusChanged?.call(StatusMedida.reprovada),
                      style: ButtonStyle(
                        backgroundColor: MaterialStateProperty.all(
                            item.status == StatusMedida.reprovada
                                ? Theme.of(context)
